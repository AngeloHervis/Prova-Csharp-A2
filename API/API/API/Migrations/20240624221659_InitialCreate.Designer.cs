...
namespace API.Migrations
{
    ...
    [Migration("20240624221659_InitialCreate")]
            ...
            modelBuilder.Entity("API.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2024, 6, 25, 19, 16, 59, 120, DateTimeKind.Local).AddTicks(9568),
                            Nome = "Trabalho"
                        },
                        new
                        {
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 6, 26, 19, 16, 59, 120, DateTimeKind.Local).AddTicks(9577),
                            Nome = "Estudos"
                        },
                        new
                        {
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 6, 27, 19, 16, 59, 120, DateTimeKind.Local).AddTicks(9583),
                            Nome = "Lazer"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.Tarefa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoriaId = "bfe4e7dc-81e4-4e47-a67b-d4fbf3e124bd",
                            CriadoEm = new DateTime(2024, 7, 1, 19, 16, 59, 120, DateTimeKind.Local).AddTicks(9711),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 6, 27, 19, 16, 59, 120, DateTimeKind.Local).AddTicks(9717),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 7, 8, 19, 16, 59, 120, DateTimeKind.Local).AddTicks(9755),
